...
const props = withDefaults(defineProps<FloatingInputProps>(), {
  type: 'text',
  error: false,
...
const effectiveType = computed(() => {
  if (props.showPasswordToggle && isPassword.value) {
...
<template>
  <div class="relative">
    ...
    />
    <button
      v-if="showPasswordToggle && isPassword"
      type="button"
      :class="toggleClass"
      tabindex="-1"
